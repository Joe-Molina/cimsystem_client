    ...
    <CardContent className=" my-1 flex flex-row flex-wrap justify-start">
      <article className=' w-3/5 flex flex-wrap border-r mt-4' >
        <div className='w-full flex  px-4'>
          <Image src={(foto != '') ? 'http://cimnet.com/fotocarnet/' + foto : 'error'} alt='foto' className='w-40 h-40 rounded-md border' width={160} height={160} />
          <div className='ml-10' >
            ...
            <div className='flex flex-wrap'>
              ...
              <DatosP nombre="fecha de nacimiento" dato={datos.fechanac ? datos.fechanac.slice(0, 10) : 'sin fecha'} />
        ...
        <DatosP nombre="fecha inicio" dato={datos.fecha ? datos.fecha.slice(0, 10) : 'sin fecha'} />
        <DatosP nombre="fecha fin" dato={datos.fin ? datos.fin.slice(0, 10) : 'no aplica'} />
        ...
        {datos.exonerado == 1 ? <DatosP nombre="fecha de exoneracion" dato={datos.fch_exon ? datos.fch_exon.slice(0, 10) : 'sin fecha'} /> : ''}
        <DatosP nombre="nota" dato={datos.nota} />
        <DatosP nombre="fecha de vencimiento del carnet" dato={datos.fevnccrnt ? datos.fevnccrnt.slice(0, 10) : 'sin fecha'} />
        <DatosP nombre="fecha de emision del carnet" dato={datos.feemicrnt ? datos.feemicrnt.slice(0, 10) : 'sin fecha'} />
