    ...
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <article className='flex border w-96  p-3 1 rounded-md hover:scale-105 transition m-4 hover:bg-slate-100'>
          <Image src={(foto != '') ? `http://cimnet.com/fotocarnet/${foto}` : '/avataricon.png'} alt='foto' className='w-40 h-40 rounded-sm' width={160} height={160} />
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogTitle>
            <div className='flex'>
              <Image src={(foto != '') ? `http://cimnet.com/fotocarnet/${foto}` : '/avataricon.png'} alt="foto del familiar" className='w-40 h-40 border rounded-sm' width={160} height={160} />
              <div>
