...
import InfoFamiliares from '@/app/(con layout)/syh/components/socio/tabSections/infoFamiliares'
import Back from '@/app/(con layout)/syh/components/header/BackButton'
