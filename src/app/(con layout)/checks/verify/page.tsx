...
import { Calendar, CheckCircle2, XCircle, Search, RefreshCw, Eye } from "lucide-react";
    ...
    <div className="w-full flex flex-col h-screen max-h-screen overflow-hidden bg-background">
      ...
      <header className="px-6 py-4 border-b flex items-center justify-between bg-card/50 backdrop-blur-sm shrink-0">
        <div className="flex items-center gap-4">
          <h1 className="text-2xl font-bold tracking-tight">Verificar Comprobantes</h1>
...
function CheckCard({ 
  ...
  return (
    <Card 
      className={cn(
        "border-l-4 transition-all duration-200 group overflow-hidden",
        isVerified ? "border-l-green-500" : "border-l-yellow-500",
        clickable && "hover:shadow-md cursor-pointer hover:scale-[1.02]"
      )}
      onClick={onClick}
    >
